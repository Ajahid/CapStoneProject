...
public class LaptopsNoteBooksSteps extends Base {
	...
	public void user_is_on_retail_website() throws IOException {
		laptopsNoteBooks.verifyDesktopMainPageText();
	...
	public void user_click_on_laptop_note_book_tab() throws IOException {
		...
		Utilities.takeScreenShot("ClickLatptops&NoteBooks");
	...
	public void user_click_on_show_all_laptop_note_book_option() throws IOException {
		...
		Utilities.takeScreenShot("ShowAllLaptops&NoteBooks");
	...
	public void user_click_on_mac_book_item() throws IOException {
		...
		Utilities.takeScreenShot("MacBook");
	}
	...
	public void user_click_on_cart_option() throws IOException {
		...
		Utilities.takeScreenShot("ClickAddToCart");
	...
	public void user_should_see_a_message_success_you_have_added_mac_book_to_your_shopping_cart() throws IOException {
		...
		Utilities.takeScreenShot("Message");
	 
	}

	@And("User should see ‘1 item(s)-602.00’ showed to the cart")
	public void user_should_see_1_item_s_showed_to_the_cart() throws IOException {
		laptopsNoteBooks.verifycartTotal();
		logger.info("User see cart Total");
		Utilities.takeScreenShot("CartTotal");
	...
	public void user_click_on_red_x_button_to_remove_the_item_from_cart() throws IOException {
		...
		Utilities.takeScreenShot("CancelCart");
	
	}

	@And("item should be removed and cart should show ‘0 item(s)’")
	public void item_should_be_removed_and_cart_should_show_0_item_s() throws IOException {
		laptopsNoteBooks.clickCartItems();
	...
	public void user_click_on_product_comparison_icon_on_mac_book() throws IOException {
		...
		Utilities.takeScreenShot("MacBookCompareProduct");
	...
	public void user_click_on_product_comparison_icon_on_mac_book_air() throws IOException {
		...
		Utilities.takeScreenShot("MacBookAirCompareProduct");
	...
	public void user_should_see_a_message_success_you_have_added_mac_book_air_to_your_product_comparison() throws IOException {
		...
		Utilities.takeScreenShot("ProductComparisonMessage");
	...
	public void user_click_on_product_comparison_link() throws IOException {
		...
		Utilities.takeScreenShot("ProductComparisonLink");
	...
	public void user_click_on_heart_icon_to_add_sony_va_io_laptop_to_wish_list() throws IOException {
		...
		Utilities.takeScreenShot("SonyHeartIcon");
	}
	...
	public void user_click_on_mac_book_pro_item() throws IOException {
		...
		Utilities.takeScreenShot("MacBookProPage");

	}

	@Then("User should see  ‘$2,000.00’ price tag is present on UI.")
	public void user_should_see_$2000_price_tag_is_present_on_ui() throws IOException {
